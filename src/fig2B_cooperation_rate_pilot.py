...
def main():
    ...
    fig, axes = plt.subplots(
        1,
        2,
        figsize=(FIG_WIDTH_IN * 0.7, FIG_WIDTH_IN * 0.3),
    ...
    fig.savefig(OUTPUT_FIGURES / "fig2B_cooperation_rate_pilot.pdf", bbox_inches="tight")
    print(f"Saved to {OUTPUT_FIGURES / 'fig2B_cooperation_rate_pilot.pdf'}")
